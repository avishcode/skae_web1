...
class ContactUsList(ListView):
    model = ContactUs
    template_name = "crm/counsellor/contact_list.html"

class ContactUsDetailView(DetailView):
    model = ContactUs
    template_name = "crm/counsellor/contact_detail.html"


class ContactUsUpdateView(UpdateView):
    model = ContactUs
    form_class = ContactForm
    template_name = "crm/counsellor/update_contact.html"
    success_url = "/contact-list"
    
class BookDemoListView(ListView):
    model = BookDemo
    template_name = "crm/counsellor/book_demo_list.html"
...
class ContactLeadFollowUpCreateView(CreateView):
    ...
    template_name = "crm/counsellor/add_contact_followup.html"
    success_url = "/contact-list"
